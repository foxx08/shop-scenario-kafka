...
import de.thi.informatik.edi.shop.shopping.messages.ArticleAddedMessage;
...
public class CartService {
	...
	public void addArticle(UUID id, UUID article) throws UnknownHostException {
		...
		this.messages.produce(topic, cart.get().getId().toString(), ArticleAddedMessage.fromCartEntry(entry, cart.get()));
